...
# ----------------------------------------------------------------------------------------------------------- #
# -----------------------------------MORNIGN CONOFINVOSIND{OVI----START-------------------------------------------- #
# ----------------------------------------------------------------------------------------------------------- #
...
@sb.request_handler(can_handle_func=lambda input : is_intent_name("MorningInit")(input))
def Morning_Init_handler(handler_input):
    ...
    if convo_route == 1:
        speech_text = (
            "GOOD MORNING USER. How did you sleep last night?")
        reprompt = "Give a quality rating to your sleep last night."
